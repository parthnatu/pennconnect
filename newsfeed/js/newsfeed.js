$(function () {
	...
	function buildUserCard(userDetails) {
		...
		img.src = 'http://homepages.cae.wisc.edu/~ece533/images/girl.png';
		img.style = 'height: 5rem; width: 5rem;';
		var cardHeaderTitle = document.createElement('h5');
		cardHeaderTitle.className = 'card-title';
		cardHeaderTitle.innerHTML = userDetails.fname.charAt(0).toUpperCase() + userDetails.fname.slice(1) + " " + userDetails.lname.charAt(0).toUpperCase() + userDetails.lname.slice(1);
		...
		connectionsCountDiv.innerHTML = '28';
